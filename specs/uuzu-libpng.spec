...
Requires: uuzu-libpng = %{epoch}:%{version}-%{release} zlib-devel pkgconfig
...
Group: Development/Libraries
Requires: uuzu-libpng-devel = %{epoch}:%{version}-%{release}
...
rm -rf $RPM_BUILD_ROOT%{lib_path}/libpng.la
rm -rf $RPM_BUILD_ROOT%{lib_path}/libpng12.la
